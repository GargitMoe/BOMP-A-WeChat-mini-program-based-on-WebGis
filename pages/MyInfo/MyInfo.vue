...
<template>
	<view class="uni-content">
		...
		<uni-list>
			...
			<uni-list-item class="item" @click="setSchool('')" title="学院" :rightText="userInfo.School||'未设置'">
			</uni-list-item>
			<uni-list-item class="item" @click="setInterest('')" title="兴趣" :rightText="userInfo.Interest||'未设置'">
			</uni-list-item>
